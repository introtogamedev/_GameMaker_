...
draw_text(itemX + 40, itemY + 260, "Cost: " + string(global.fishitemCost[ShopItem.DamageBoost]));
...
draw_text(itemX + 40, itemY + 260, "Cost: " + string(global.fishitemCost[ShopItem.SpeedBoost]));
